...
| [operations.md](operations.md) | Runbooks. First run, adoption, changes, key creation, rotation, retirement, forgetting, recovery, and looking after state. |
...
| [receiver-protocol.md](receiver-protocol.md) | The contract for writing a command receiver: the envelope, the empty environment, the exit codes. |
