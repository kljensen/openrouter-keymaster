...
use openrouter_keymaster_core::client::{ManagementKey, Options};
use openrouter_keymaster_core::ids::{OperationId, RemoteName};
use openrouter_keymaster_core::ops::{self, Context, Paths, PlanFingerprint};
use openrouter_keymaster_core::state::{BeginCreate, Origin, State, StateFile, Transition};
...
fn receiver_fingerprint() -> openrouter_keymaster_core::ids::ReceiverFingerprint {
